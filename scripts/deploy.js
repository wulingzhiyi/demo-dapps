...
async function main() {
  ...
  const myContract = await hre.ethers.deployContract('PolymerToken', constructorArgs);
  ...
  console.log(
    `Contract PolymerToken deployed to ${myContract.target} on network ${networkName}`
  );
}
